...
public class Agent extends TwoDimCell
{
    ...
    protected String[] waitingDirections = { "No", "No", "No", "No", "No", "No", "No", "No" };
    ...
    public void deltext(double e, message x)
    {
        ...
        {
            if (comingDirections[i] == "WANTTOCOME")
            {
                comingShuffle.add(i);
            }
        ...
        {
            holdIn(status + ":- OneMoving " + finalDirection, 0);
        }
        else if (finalDirection != "No" && waitDirection != "No")
        {
            holdIn(status + ":- ParallelMoving " + finalDirection, 0);
        }
    ...
    public void deltint()
    {
        ...
        else if (phase.contains("ParallelMoving"))
        {
            holdIn(status + ":- OneMoving " + finalDirection, 0);
        }
        else
    ...
    public message out()
    {
        ...
        else if (phase.contains("OneMoving"))
        {
            for (int i = 0; i < neighborOut.length; i++)
            {
