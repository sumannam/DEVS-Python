...
initialize();
    ...
    {
        preferredSize = new Dimension(563, 200);
        ((ViewableComponent)withName("MultiSco")).setPreferredLocation(new Point(140, 39));
        ((ViewableComponent)withName("processor_1")).setPreferredLocation(new Point(249, 132));
        ((ViewableComponent)withName("processor_2")).setPreferredLocation(new Point(-3, 124));
    }
}
