...
public void efConstruct(double int_arr_t,double observe_t){
    ...
    {
        preferredSize = new Dimension(500, 125);
        ((ViewableComponent)withName("t")).setPreferredLocation(new Point(-2, 55));
        ((ViewableComponent)withName("g")).setPreferredLocation(new Point(211, 9));
    }
}
