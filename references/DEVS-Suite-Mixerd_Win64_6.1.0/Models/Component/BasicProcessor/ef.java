...
public void efConstruct(double int_arr_t,double observe_t){
    ...
    ViewableAtomic g = new genr("generator",int_arr_t);
    ViewableAtomic t = new transd("transducer",observe_t);
    ...
    {
        preferredSize = new Dimension(471, 185);
        ((ViewableComponent)withName("generator")).setPreferredLocation(new Point(-4, 23));
        ((ViewableComponent)withName("transducer")).setPreferredLocation(new Point(156, 103));
    }
}
